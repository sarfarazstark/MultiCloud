...
#- * -coding: utf - 8 - * -#(c) oVoIndia | oVo - HxBots
...
from multiupload.fsub
import *
from multiupload.utils
import downloader, humanbytes
from config
import Config
...
reqmsg = f ''
'Req User: [{xx.first_name}](tg://user?id={xx.id})
FileName: {
        amjana.file.name
}
FileSize: {
...
await msg.edit(hmm, buttons = (
        [Button.url('📦 Download', r.json()["data"]["file"]["url"]["short"])], [Button.url('Support Chat 💭', 't.me/bluewhalegroup')]
))
